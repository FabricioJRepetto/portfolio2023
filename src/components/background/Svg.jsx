...
export const Svg = () => {
    return (
        <svg id="Layer_1" className='bg-svg' data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 4320">
            <defs>
            ...
            <path d="M-36.75,3937.52a1113.23,1113.23,0,0,0,230.75,168c499.51,272.57,1153.12,130.42,1759.47-311.59" fill="none" stroke="#f97316" strokeMiterlimit="10" />
            <path d="M-20.8,3984.75a1138.19,1138.19,0,0,0,192.57,135.8c507,283.59,1174.88,147.71,1799.05-293.77" fill="none" stroke="#f43f5e" strokeMiterlimit="10" />
            <path d="M-5.47,4037.17A1165,1165,0,0,0,149.76,4143.3c514.81,293.91,1196.7,163.43,1838-278.32" fill="none" stroke="#38bdf8" strokeMiterlimit="10" />
